 ...
 if (joyposup < 460)
  {
    ...
    joyposup = joyposup - 460; // This produces a negative number
    joyposup = joyposup * -1;  // Make the number positive

    MotorSpeed3 = map(joyposup, 0, 460, 0, 255);
    
  }
  else if (joyposup > 564)
  {
    // This is down
    ...
    MotorSpeed3 = map(joyposup, 564, 1023, 0, 255);
 }
  else
  {
    // This is Stopped
